...
[![Flattr this git repo](http://api.flattr.com/button/flattr-badge-large.png)](https://flattr.com/submit/auto?user_id=darthwade&url=https://github.com/johnmwenda/angular-loading-darthwade-fork.git&title=Angular%20Loading&language=&tags=github&category=software) 
...
Using `git`:
```shell 
$ git clone https://github.com/johnmwenda/angular-loading-darthwade-fork.git
```
